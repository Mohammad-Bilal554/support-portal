...
<title>403 — <?= htmlspecialchars($appName) ?></title>
...
body::before {content:'';position:fixed;width:500px;height:500px;border-radius:50%;background:#f59e0b;filter:blur(120px);opacity:.08;top:-100px;right:-100px;pointer-events:none;}
.box {max-width:480px;position:relative;z-index:1;}
.code {font-size:7rem;font-weight:800;line-height:1;color:#f59e0b;text-shadow:0 0 60px #f59e0b55;margin-bottom:.25rem;}
...
.btn-back {background:#f59e0b;color:#fff;border:none;padding:.65rem 1.5rem;border-radius:10px;font-weight:600;font-size:.875rem;text-decoration:none;display:inline-flex;align-items:center;gap:.4rem;transition:all .2s;}
