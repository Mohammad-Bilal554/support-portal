...
body::before {content:'';position:fixed;width:500px;height:500px;border-radius:50%;background:#3b82f6;filter:blur(120px);opacity:.08;top:-100px;right:-100px;pointer-events:none;}
.box {max-width:480px;position:relative;z-index:1;}
.code {font-size:7rem;font-weight:800;line-height:1;color:#3b82f6;text-shadow:0 0 60px #3b82f655;margin-bottom:.25rem;}
...
.btn-back {background:#3b82f6;color:#fff;border:none;padding:.65rem 1.5rem;border-radius:10px;font-weight:600;font-size:.875rem;text-decoration:none;display:inline-flex;align-items:center;gap:.4rem;transition:all .2s;}
