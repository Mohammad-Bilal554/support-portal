...
const SupportPortal = {
  ...
  initAlerts() {
    ...
    document
      .querySelectorAll(".alert-dismissible[data-auto-dismiss]")
      .forEach((alert) => {
        setTimeout(() => {
  ...
  showToast(message, type = "success", duration = 4000) {
    ...
    if (!container) {
      ...
      container.style.cssText =
        "position:fixed;top:1rem;right:1rem;z-index:9999;display:flex;flex-direction:column;gap:.5rem;min-width:280px;max-width:380px;";
